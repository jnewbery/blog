...
Category: blog
Summary: An analysis of breakeven prices for public EV chargers in the UK.
Date: 2023-02-08
Slug: the-economics-of-public-ev-charging-in-the-uk


_Originally [published on the Gridcog Blog][original blog post]_.
...
<img class="center-img" src="{attach}ev-charger-leasing-costs.png" alt="Leasing costs for EV chargers">
...
<img src="{attach}ev-charger-project-gridcog.png" alt="The EV charger project in Gridcog">

The graphs below show the total energy delivered and load factor of each
charger for each year.

<img src="{attach}ev-charger-supplied-energy.png" alt="Energy Supplied by EV Chargers">

<img src="{attach}ev-charger-utilisation.png" alt="Load factor of EV Chargers">
...
<img src="{attach}raw-interval-data.png" alt="Energy import and EV charger interval data">
...
<img src="{attach}breakeven-ev-charging-cost.png" alt="Breakeven price for different EV Chargers">
...
<img src="{attach}breakeven-table.png" alt="Table of breakeven price for different EV chargers">
...
<img src="{attach}cost-stack.png" alt="Cost stack for different EV chargers">

Finally, we might want to ask ourselves what the breakeven price is over the
entire 10 year project:

<img class="center-img" src="{attach}breakeven-price.png" alt="Overall breakeven price for different chargers">
